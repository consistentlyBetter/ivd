...
```
## Data
The illustration uses openly accessible data from ... 
...
We will predict `math_proficiency` which is a standardized variable capturing math proficiency at the end of grade ...
